            ...
            <div className="p-4 flex gap-4">
                ...
                <div className="h-[56px] bg-black rounded-2xl flex justify-evenly items-center font-semibold text-[12px]">
                    <div
                        ...
                        className={`rounded-xl px-[55px] h-[45px]  ${isActive === "aboutme" ? 'bg-[#28292F] text-white shadow-[5px_23px_38px_4px_black]' : 'text-[#b4aeae]'} 
                    ...
                    <div
                        ...
                        className={`rounded-xl px-[54px] h-[45px] ${isActive === "exp" ? 'bg-[#28292F] text-white shadow-[5px_23px_38px_4px_black]' : 'text-[#b4aeae]'} 
                        flex justify-center items-center ml-2 hover:cursor-pointer   
                    ...
                    <div
                        ...
                        className={`rounded-xl px-[48px] h-[45px] ${isActive === "rec" ? 'bg-[#28292F] text-white shadow-[5px_23px_38px_4px_black]' : 'text-[#b4aeae]'}
